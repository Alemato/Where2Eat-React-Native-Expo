...
import {
  CREATE_BOOKINGS_FULFILLED_ACTION,
  CREATE_BOOKINGS_PENDING_ACTION,
  CREATE_BOOKINGS_REJECTED_ACTION,
  GET_BOOKINGS_FULFILLED_ACTION,
  GET_BOOKINGS_PENDING_ACTION,
  GET_BOOKINGS_REJECTED_ACTION,
  ...
  PATCH_BOOKINGS_FULFILLED_ACTION,
  PATCH_BOOKINGS_PENDING_ACTION,
  PATCH_BOOKINGS_REJECTED_ACTION,
  ...
  extraReducers: (builder) => {
    builder.addMatcher(
        isAnyOf(LOGIN_PENDING_ACTION, REGISTRAZIONE_PENDING_ACTION,
            ...
            GET_RISTORANTE_PENDING_ACTION,
            MODIFICA_ACCOUNT_PENDING_ACTION, GET_BOOKINGS_PENDING_ACTION,
            PATCH_BOOKINGS_PENDING_ACTION, CREATE_BOOKINGS_PENDING_ACTION),
        (state, action) => {
          state.loading = true;
        }).
        addMatcher(isAnyOf(LOGIN_FULFILLED_ACTION, LOGIN_REJECTED_ACTION,
                ...
                RICERCA_REJECTED_ACTION,
                GET_RISTORANTE_REJECTED_ACTION, MODIFICA_ACCOUNT_REJECTED_ACTION,
                GET_BOOKINGS_FULFILLED_ACTION, GET_BOOKINGS_REJECTED_ACTION,
                PATCH_BOOKINGS_FULFILLED_ACTION, PATCH_BOOKINGS_REJECTED_ACTION,
                CREATE_BOOKINGS_FULFILLED_ACTION, CREATE_BOOKINGS_REJECTED_ACTION),
            (state, action) => {
              state.loading = false;
            });
  },
